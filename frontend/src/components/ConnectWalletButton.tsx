...
const ConnectBtn: React.FC<ConnectBtnProps> = ({ networks = false }) => {
  ...
  const buttonClasses =
    "bg-white/10 backdrop-blur-xl hover:bg-white/20 text-white py-2.5 px-6 rounded-xl transition-all duration-300 ease-in-out text-sm font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 border border-white/20 hover:border-white/40";
