...
import { AgentKyroApiClient, Transaction } from "@/utils/api";
...
export default function TransactionHistory() {
  ...
  const fetchTransactionHistory = useCallback(async () => {
    ...
    try {
      ...
      const response = await AgentKyroApiClient.transactions.getTransactionHistory(address, params);
  ...
  const fetchScheduledTransactions = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await AgentKyroApiClient.transactions.getScheduledTransactions(address);
  ...
  const fetchConditionalTransactions = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await AgentKyroApiClient.transactions.getConditionalTransactions(address);
