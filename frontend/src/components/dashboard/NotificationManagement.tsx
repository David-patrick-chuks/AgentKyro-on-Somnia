...
import { AgentKyroApiClient, Notification, NotificationSubscription } from "@/utils/api";
...
export default function NotificationManagement() {
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      ...
      const response = await AgentKyroApiClient.notifications.getNotifications(address, params);
  ...
  const fetchSubscriptions = useCallback(async () => {
    ...
    try {
      const response = await AgentKyroApiClient.notifications.getNotificationSubscriptions(address);
  ...
  const handleMarkAsRead = async (notificationIds: string[]) => {
    ...
    try {
      const response = await AgentKyroApiClient.notifications.markNotificationsAsRead(address, notificationIds);
  ...
  const handleDeleteSubscription = async (subscriptionId: string) => {
    ...
    try {
      const response = await AgentKyroApiClient.notifications.deleteNotificationSubscription(address, subscriptionId);
  ...
  const handleCreateSubscription = async () => {
    ...
    try {
      const response = await AgentKyroApiClient.notifications.subscribeToNotifications(address, newSubscription);
